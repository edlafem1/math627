...
filename = "run_" + str(sys.argv[1]) + "_" + str(sys.argv[2]) + "_" + str(sys.argv[3]) + ".slurm"

slurm_file = open(filename, "w")

slurm_file.write("#!/bin/bash\n")
slurm_file.write("#SBATCH --job-name=" + str(sys.argv[1]) + "\n")
slurm_file.write("#SBATCH --output=" + str(sys.argv[1]) + "_" + str(sys.argv[2]) + "_" + str(sys.argv[3]) + ".out\n")
slurm_file.write("#SBATCH --error=" + str(sys.argv[1]) + "_" + str(sys.argv[2]) + "_" + str(sys.argv[3]) + ".err\n")
slurm_file.write("#SBATCH --partition=develop\n")
